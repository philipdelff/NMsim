...
You should be familiar with basic `NMsim` arguments as described in [`NMsim-simulate.html`](https://philipdelff.github.io/NMsim/articles/NMsim-simulate.html).

This vignette will be using the same model and simulation input data as in [`NMsim-simulate.html`](https://philipdelff.github.io/NMsim/articles/NMsim-simulate.html)
```{r}
