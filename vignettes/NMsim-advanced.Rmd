...
vignette: >
  %\VignetteIndexEntry{Simulation Advanced}
...
## Objectives
This vignettes aims at enabling you to Use `NMsim` to simulate
...
This vignette will be using the same model as simulated in [`NMsim-simulate.html`](https://philipdelff.github.io/NMsim/articles/NMsim-simulate.html)
```{r}
