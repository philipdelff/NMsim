...
Unfortunately, `tidyvpc` has been (hopefully temporarily) removed from
CRAN, so the plot is currently not rendered here. But this code will
plot it with `tidyvpc` installed.
