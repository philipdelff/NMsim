...
Then run `NMsim` like this. We include `text.table="ROW IPRED"`
because we need the row identifier for merging, and the individual
predictions are what we are running this for.
