...
## NMreadTab("~/wdirs/NMsim/inst/examples/nonmem/xgxr021.phi")
## NMreadTab("~/wdirs/NMsim/inst/examples/nonmem/xgxr021.ext")
...
the simplest thing we can think of. Simulate a new subject on the considerd multiple dose regimen with our estimated PK model from the single dose study.
