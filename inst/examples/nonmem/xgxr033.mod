...
$ESTIMATION METHOD=SAEM INTERACTION NOABORT NBURN=1000 NITER=1000 CTYPE=3 MAX=99999 NSIG=3 SEED=3442 PRINT=10 RANMETHOD=P MSFO=xgxr033.msf

$ESTIMATION METHOD=IMP INTERACTION EONLY=1 NITER=20 PRINT=1 ISAMPLE=5000 RANMETHOD=P
																	    
$COV PRINT=E

$TABLE ROW LTVKA LTVV2 LTVV3 LTVCL LTVQ KA V2 V3 CL Q PRED IPRED Y NOPRINT FILE=xgxr033_res.txt
$TABLE ETAS(1:LAST) NOAPPEND NOPRINT FILE=xgxr033_etas.txt
