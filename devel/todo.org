...
*** TODO [#A] Rename method.execute="directory" to method.execute="nmsim"

*** TODO [#A] Warn against method.execute="nmsim" for NMexec directly

*** TODO [#A] Disable method.update.inits="nmsim". 
I am concerned if VarCov is similarly affected
*** pkgdown
...
*** TODO [#A] if using path.nonmem, test that it exists
