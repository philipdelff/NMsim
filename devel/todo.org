...
*** TODO [#A] Add @return to all functions

*** TODO [#A] Clean up code files

*** TODO [#A] Issue with varCov for n=1 repetitions.
...
*** TODO Rename sge to parallel
** NMexecDirectory
*** TODO [#A] Clean up after switching to absolute paths
** NMsim
*** TODO Support for modifications to control stream(s).
...
*** TODO Check for existance of estimate files
...
**** TODO What if .phi or others needed?
